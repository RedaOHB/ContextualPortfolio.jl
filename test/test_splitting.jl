@testset "Data Splitting" begin
        ...
        # Check dimensions
        @test size(Train_data, 1) == estimation_horizon*21  # 1008 observations 
        @test size(Train_data, 2) == n_assets               # 10 assets
        @test size(Test_data, 1) == evaluation_horizon*21   # 252 observations
        @test size(Test_data, 2) == n_assets                # 10 assets
        # 21 is the number of trading days in one month
